...
// Gallery page
            let items =[{id:1, title: "Bagging Watercress", image_url: "images/gallery/bagging_watercress.JPEG", description: "Carefully placing Watercress into produce bags."},
                ...
                {id:4, title: "Watercress Close-up", image_url: "images/gallery/closeup_water.JPEG", description: "Image of watercress at the top of the bed where the water flows."},
            ...
            document.addEventListener('DOMContentLoaded', () => {
                // Initialize items and display all by default
